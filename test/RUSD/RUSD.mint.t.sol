...
contract Mint is RUSDSetup {
    ...
    function test_WithData_ShouldRevertIfDataIsZeroLength() public {
        vm.expectRevert(IRUSD.DataLengthZero.selector);
        rusd.mint(address(this), MINT_AMOUNT, "");
    }

    function test_WithData_ShouldRevertIfCrossChainAction1() public {
